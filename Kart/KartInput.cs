...
public class KartInput : KartComponent, INetworkRunnerCallbacks
{
    public struct NetworkInputData : INetworkInput
    {
        ...
        public const uint UseItem = 1 << 4;           // Shift키 - 순차 사용
        public const uint UseSecondaryItem = 1 << 5;  // E키 - 직접 사용 (옵션)
        public const uint UseBoosterItem = 1 << 6;    // R키 - 직접 사용 (옵션)
    ...
    [SerializeField] private InputAction useSecondaryItem;  // 두 번째 일반 아이템
    [SerializeField] private InputAction useBoosterItem;     // 부스터 아이템
    [SerializeField] private InputAction pause;

    private bool _useItemPressed;
    private bool _useSecondaryItemPressed;
    private bool _useBoosterItemPressed;  // 부스터 플래그
